...
<html>
	...
	<body>
		<a href="#create-renter" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-renter" class="content scaffold-create" role="main">
			...
			<g:form url="[resource:renterInstance, action:'save']" >
				<fieldset class="form">
