        ...
        <ul class="nav navbar-nav navbar-right">
            ...
            <li class="dropdown hidden-xs hidden-sm">
                ...
                <ul class="dropdown-menu extended notification">
                    ...
                    <li>
                        <a href="javascript:void(0);">
                            <span class="photo"><img src="${resource(file: 'assets/img/demo/avatar-1.jpg')}" alt="" /></span>
                            <span class="subject">
                    ...
                    <li>
                        <a href="javascript:void(0);">
                            <span class="photo"><img src="${resource(file: 'assets/img/demo/avatar-2.jpg')}" alt="" /></span>
                            <span class="subject">
                    ...
                    <li>
                        <a href="javascript:void(0);">
                            <span class="photo"><img src="${resource(file: 'assets/img/demo/avatar-3.jpg')}" alt="" /></span>
                            <span class="subject">
