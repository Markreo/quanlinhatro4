...
class gsp_quanlinhatro4_roomcreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/room/create.gsp" }
public Object run() {
Writer out = getOut()
...
createTagBody(1, {->
printHtmlPart(3)
invokeTag('breadcrumbs','qlnhatro',13,['current':("Đăng kí phòng")],-1)
printHtmlPart(4)
})
