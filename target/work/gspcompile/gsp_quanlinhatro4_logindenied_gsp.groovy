...
class gsp_quanlinhatro4_logindenied_gsp extends GroovyPage {
...
createTagBody(2, {->
createTagBody(3, {->
invokeTag('message','g',2,['code':("springSecurity.denied.title")],-1)
})
...
createTagBody(1, {->
printHtmlPart(2)
invokeTag('message','g',7,['code':("springSecurity.denied.message")],-1)
printHtmlPart(3)
})
