...
class gsp_quanlinhatro4_basecreateFirstRegion_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/base/createFirstRegion.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('form','g',97,['url':([controller: 'region', action: 'saveFirstRegion', id: user.id]),'class':("form-horizontal"),'id':("createFirstRegion")],2)
printHtmlPart(10)
